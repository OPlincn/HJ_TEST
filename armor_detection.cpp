...
{
    save_num_cnt = 0;
    FileStorage fs("/Users/oplin/CLionProjects/opencv/HJ_homework3/other/detect_data.yaml", FileStorage::READ);
    ...
    enemy_color = 1;  // BLUE=2 RED=1
    fs.release();
    cout << "file's color:" << enemy_color << endl;
}
...
//            cout<<"is_Light   "<<endl;
                ...
                0 <= rect.y && 0 <= rect.height && rect.y + rect.height <= _src.rows)
            {
                ...
                cout << "our enemy: " << enemy_color << endl;
